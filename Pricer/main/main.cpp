...
// BS Merton Model
#include "CDF_MERTON.cpp"
#include "Calculator_Merton.cpp"
// Heston Model
#include "CDF_HESTON.cpp"
#include "Calculator_Heston.cpp"
...
int main(){
	...
	Calculator pricer(r, v, T, s0, alpha, eta, N);
	CalculatorMerton pricerMerton(r, v, T, s0, alpha, lambda, mu, delta, eta, N);
	CalculatorHeston pricerHeston(r, v, T, s0, alpha, k, theta, sigma, p, v0, eta, N);
